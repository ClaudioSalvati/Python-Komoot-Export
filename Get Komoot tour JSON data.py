...
# tour_url = f"https://www.komoot.de/user/{client_id}/tours?type=recorded"
sport_types = ""
type = "tour_recorded"
sort_field = "date"
sort_direction = "desc"
...
base_url = "https://www.komoot.de/tour/"
...
# # Output all tours made
# for idx, tour in enumerate( data["_embedded"]["tours"]):
#     print(f"({idx+1}) {tour['id']}")
